...
Reversing a rule that is already in force is not a one-line edit - follow "Propagating a Rule Change"
in references/protocols/register.md: change every table that encodes it, and write in the
sense-dependent exceptions a blind find-and-replace would break.
